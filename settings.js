...
global.alivemsg = `📤මම ඉන්නව බල්ලො කියපන්😒
🤷‍♀️උබට කොහොමද උදව් කරන්නෙ කියපන්කො😩` //Costomize Alive Message (type your message in `` )
...
//owner v card
global.vcardowner = ['+94703833853'] // owner number
global.ownername = "࿓⍙ʜⷮᴬ̶ུᏕᴇⷨ͢: kavindu sachintha🍃᭄" // owner name
global.ytname = "Anykize.lk" // yt chanel name
global.socialm = "ඒව නෑ" // github or insta name
global.location = "Srilanka, Anuradhapura, Kahatagasdigiliya" // location
...
global.owner = ['+94703833853']
global.ownertag = '+94703833853' //your tag number
global.botname = 'Sexy🎀😁' //ur bot name
global.packname = "Bot Sticker" // sticker packname
global.author = "Zr╺Kizer" // sticker author
global.dragonemoji = '🧩' // Menu emoji
global.footer = '[ ◉Kavindu sachintha]' //

global.button = '☰ ඔබපන්කො ☰' //Costomize A Button Name In Alive Message
global.btnurl = 'http://Wa.me/±703833853?text=_Hi_|:♥️🧸🙊_' //Change Your Button's URL

//database
global.premium = ['+94703833853'] //ur premium numbers
...
global.mess = {
    success: 'හරි බන් ✅',
    admin: 'ඇඩ්මින්ලට විතරයි බල්ලො!😉',
    botAdmin: 'මට ඇඩ්මින් වෙන්න ඕනෙ😥',
    owner: 'ඕව්නර්ට විතරයි ගොනෝ පුලුවන්😉',
    group: 'ගෘප් එකේ විතරයි බන් තියෙන්නෙ!',
    private: 'මේක තියෙන්නෙ ප්‍රයිවට් චැට් වල විතරයි යකෝ😩!',
    bot: 'මේක මට විතරයි යකෝ තියෙන්නෙ උබට බෑ😝',
    wait: '👉👈පොඩ්ඩක් හිටපන්😷✋...',
    error: 'වැරදීනෙ බන්!! කල්ඉක්උට්හ් වෙලා තියෙන්නෙ බන්🤔!',
    endLimit: 'අද දවසට වද දුන්න ඇති නේද😩😒,පැය 12කින් පස්සෙ වරෙන් වද නොදී😩',
    linkm: 'ලින්ක් එක කෝ ප##🤬?',
    nsfw: 'උබ කියන එක ඇක්ටිව් වෙලා නෑ උලමො😏, ඇඩ්මින්ට පොඩ්ඩක් කියපන්',
    banChat: 'මාව හොස්පිට්ල් දාන්න අයියෝ...😩 මට කෙලවෙල තියෙන්නෙ😒 කන පලාගන්නෙ නැතුව ගෘප් එකේ ඕනර් අයියට කියපන්🥺, please contact the owner to unban',
    badwords: '*🚫කුනුහර්ප කියන් එන්න එපා😒!*\n\n⚠️ ආය මම උබට කියන්නෑ... ⚠️',
    caption: 'Generated by: ◉ *Chamika dulmina*'
} // END \\
    global.limitawal = {
    premium: "Infinity",
    free: 12,
